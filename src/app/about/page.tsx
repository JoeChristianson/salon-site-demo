...
const About = ({}: Props) => {
    return <main className={styles['main']}>
        ...
        >
            ...
            <Paragraph>Your satisfaction is our highest priority. From the moment you step into our salon, we strive to provide a welcoming and luxurious atmosphere where you can unwind and enjoy being pampered. We use only the finest products and equipment, ensuring the highest standards of quality and care in all our services. At Glamour Grove, we are not just a salon – we are a community of beauty enthusiasts who cherish the joy of making our clients look and feel their absolute best.</Paragraph>
            </div>
        </ImageAndTextSideBySide>
        <Team1
